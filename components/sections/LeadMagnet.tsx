...
import { AlertCircle, CheckCircle2, BarChart3, Zap, Video, XCircle, AlertTriangle } from "lucide-react";
import Link from "next/link";
import { motion } from "framer-motion";
import { useState } from "react";
import { useForm } from "react-hook-form";
import { zodResolver } from "@hookform/resolvers/zod";
import { websiteAnalysisSchema, type WebsiteAnalysisData } from "@/lib/validations";
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              <span className="text-sm font-medium text-orange-300">🔍 Бесплатная проверка</span>
            </motion.div>
            ...
            >
              Проверим ваш сайт на наличие Google Analytics, GTM, Meta Pixel и других инструментов трекинга. Узнайте, что работает, а что нет — за 30 секунд.
            </motion.p>
            ...
            >
              ...
              <div className="space-y-3 relative z-10 mb-6">
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="text-sm font-medium text-white">Google Tag Manager</div>
                    <div className="text-xs text-slate-400">Обнаружен и работает</div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="text-sm font-medium text-white">Meta Pixel</div>
                    <div className="text-xs text-slate-400">Обнаружен, но не работает</div>
                  </div>
                </motion.div>
                ...
                >
                  <XCircle className="w-5 h-5 text-red-500 flex-shrink-0" />
                  <div className="flex-1">
                    <div className="text-sm font-medium text-white">Server-side tracking</div>
                ...
                >
                  ...
                  <div className="text-sm text-orange-300 font-medium">Вы теряете ~48% конверсий</div>
                </motion.div>
              </div>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 relative z-10">
                ...
                <p className="text-xs text-slate-500 text-center">
                  Обычно анализ занимает 30-60 секунд. Детальный отчёт придёт на email.
                </p>
              </form>
              ...
              <div className="pt-4 border-t border-slate-700 relative z-10">
                <p className="text-sm text-slate-400 text-center mb-3">
                  Или получите персональный видео-аудит:
                </p>
                <Button
                  variant="outline"
                ...
                >
                  ...
                  Заказать видео-аудит (бесплатно)
                </Button>
              </div>
            </motion.div>
          </div>
