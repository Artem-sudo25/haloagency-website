...
const faqs = [
  {
    ...
    answer:
      "Мы — исполнительные специалисты с 10-летней практикой. Создаем кампании, которые приводят клиентов, увеличивают продажи и позволяют компаниям масштабироваться без лишних затрат на бюджет. Работаем с e-shop и компаниями, которые инвестируют минимум 50 тысяч крон в месяц на онлайн-маркетинг.",
  },
  {
      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-6 leading-tight text-transparent bg-clip-text bg-gradient-to-r from-white via-blue-400 to-purple-400">
            Честность и подкрепленность<br className="hidden md:block" /> твердыми данными, за это отвечаем
          </h2>
        </div>
