...
import { ArrowRight, BarChart3, Code2, Megaphone, Sparkles } from "lucide-react";
...
export default function Services() {
    const services = [
        {
            ...
            description: "Современные сайты на Next.js за 3-7 дней. От landing page до полноценного e-commerce. Быстро, SEO-ready, mobile-first.",
            price: "От 15,000 CZK",
            link: "/web",
        ...
        },
        {
            icon: Megaphone,
            title: "Реклама (Ads)",
            description: "Google Ads + Meta с правильным server-side tracking. Настройка за 2 дня, ведение от 8k/мес. Оптимизация на данных, не на догадках.",
            price: "От 8,000 CZK/мес",
            link: "/ads",
        ...
        },
        {
            ...
            description: "Server-side GTM + Meta CAPI через Stape.io. Восстанавливаем 20-40% потерянных данных. Точность 70-85% против 50-60% стандартного setup.",
    ...
    return (
        <section id="services" className="py-16 md:py-24 px-4 bg-[#0A1628] relative overflow-hidden">
            ...
            <div className="container mx-auto max-w-6xl relative z-10">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 mb-4 md:mb-6 backdrop-blur-sm">
                        <span className="text-sm font-medium text-gray-300">🔧 Наши услуги</span>
                    </div>
                        ...
                        <Link key={index} href={service.link}>
                            ...
                            >
                                ...
                                <div className="relative z-10">
                                    ...
                                    {/* Price Badge */}
                                    <div className={`inline-block px-3 py-1.5 rounded-lg bg-gradient-to-r ${service.gradient} bg-opacity-20`}>
                ...
                <div className="mt-12 text-center">
                    <Link href="/#pricing" className="inline-flex items-center gap-2 text-lg text-gray-300 hover:text-white transition-colors group">
