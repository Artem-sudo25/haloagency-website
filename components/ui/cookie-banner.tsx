                ...
                <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
                  ...
                  <div className="flex items-start justify-between gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl bg-gray-50 border border-[#1A1A1A]/5">
                    <div className="flex-grow min-w-0">
                      <h4 className="text-xs sm:text-sm font-semibold text-[#1A1A1A] mb-1">{t("settings.necessary.title")}</h4>
                      <p className="text-[10px] sm:text-xs text-[#1A1A1A]/60">{t("settings.necessary.description")}</p>
                    </div>
                  ...
                  <div className="flex items-start justify-between gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl bg-gray-50 border border-[#1A1A1A]/5">
                    <div className="flex-grow min-w-0">
                      <h4 className="text-xs sm:text-sm font-semibold text-[#1A1A1A] mb-1">{t("settings.analytics.title")}</h4>
                      <p className="text-[10px] sm:text-xs text-[#1A1A1A]/60">{t("settings.analytics.description")}</p>
                    </div>
                    <button
                  ...
                  <div className="flex items-start justify-between gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl bg-gray-50 border border-[#1A1A1A]/5">
                    <div className="flex-grow min-w-0">
                      <h4 className="text-xs sm:text-sm font-semibold text-[#1A1A1A] mb-1">{t("settings.marketing.title")}</h4>
                      <p className="text-[10px] sm:text-xs text-[#1A1A1A]/60">{t("settings.marketing.description")}</p>
                    </div>
                    <button
