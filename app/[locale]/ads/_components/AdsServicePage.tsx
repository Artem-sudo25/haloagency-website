      ...
      <div className="relative z-10">
          ...
          <div className="container mx-auto grid max-w-7xl grid-cols-1 gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
              ...
              <div className="flex flex-col gap-4 sm:flex-row">
                ...
                >
                  <Link
                    href="/contact"
                    data-cta-track="true"
                    data-cta-name={tc("serviceTemplate.getReviewAndPlan")}
                    data-cta-location="ads_service_hero"
                    data-cta-category="primary"
                  >
                    {tc("serviceTemplate.getReviewAndPlan")}
                  </Link>
                </Button>
                <Link
                  href="/ads"
            ...
            <div className="rounded-3xl border-2 border-[#1A1A1A] bg-white p-8 shadow-[8px_8px_0px_0px_#1A1A1A]">
              ...
              >
                ...
                <span className="text-sm font-bold uppercase tracking-wide text-[#1A1A1A]">
                  {tc("serviceTemplate.importantAtStart")}
                </span>
              </div>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              {offerCards.map((card) => (
                <div
                  key={card.title}
                  className="rounded-3xl border-2 border-[#1A1A1A] bg-[#F5F5F7] p-8 shadow-[8px_8px_0px_0px_#1A1A1A]"
                >
                  <div
                    className="mb-5 flex h-12 w-12 items-center justify-center rounded-xl border-2 border-[#1A1A1A] shadow-[4px_4px_0px_0px_#1A1A1A]"
                    style={{ backgroundColor: accentColor }}
        ...
        <section className="px-4 py-16 md:py-24">
          <div className="container mx-auto grid max-w-6xl gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
            ...
            <div className="rounded-3xl border-2 border-[#1A1A1A] bg-[#1A1A1A] p-8 text-white shadow-[8px_8px_0px_0px_#FF3366] lg:sticky lg:top-28">
              <div className="mb-2 text-sm font-bold uppercase tracking-wide text-white/50">
                {tc("serviceTemplate.priceGuide")}
              </div>
              <div className="mb-1 text-base font-bold text-white/75">
                {priceLabel}
              </div>
              <div
              ...
              <Button
                asChild
                size="lg"
                className="h-12 w-full rounded-xl border-2 border-white/20 bg-[#FF3366] px-8 font-bold text-white shadow-[4px_4px_0px_0px_rgba(255,255,255,0.15)] transition-all hover:-translate-x-[2px] hover:-translate-y-[2px] hover:bg-[#FF3366] hover:shadow-[6px_6px_0px_0px_rgba(255,255,255,0.15)]"
              >
                <Link
                  href="/contact"
                  data-cta-track="true"
                  data-cta-name={tc("cta.discussProject")}
                  data-cta-location="ads_service_pricing"
                  data-cta-category="primary"
                >
                  {tc("cta.discussProject")}
                </Link>
              </Button>
            </div>
          </div>
