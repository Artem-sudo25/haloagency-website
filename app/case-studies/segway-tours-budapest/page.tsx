    ...
    return (
        <CaseStudyLayout
            ...
            challenge={{
                ...
                description: "Туристический рынок Будапешта перенасыщен. Компания сильно зависела от дорогих комиссий агрегаторов (Viator, TripAdvisor) и хотела получать больше прямых продаж через свой сайт.",
                points: [
            ...
            solution={{
                ...
                description: "Мы сделали ставку на SEO-оптимизацию контента для long-tail запросов и запустили таргетированную рекламу на туристов, которые уже находятся в городе.",
                technologies: ["WordPress Optimization", "Google Ads (Search + Maps)", "Meta Ads (Geo-fencing)", "Google Analytics 4"],
                features: [
            ...
            results={{
                ...
                description: "Доля прямых бронирований выросла до 60%, что существенно увеличило маржинальность бизнеса. Сайт стабильно держится в ТОП-3 по ключевым запросам.",
                stats: [
