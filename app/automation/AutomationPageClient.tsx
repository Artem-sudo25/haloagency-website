...
const techStack = [
  {
    ...
    helper:
      "Автоматически передаём данные между сайтом, CRM, почтой и мессенджерами.",
    icon: Workflow,
    bg: "bg-[#FFD166]",
  },
  {
    ...
    label: "AI для рутины",
    helper:
      "Ответы, анализ и классификация заявок — там, где это реально экономит время.",
    icon: Bot,
    bg: "bg-[#06D6A0]",
  },
  {
    ...
    helper:
      "Когда нужно нестандартно: проверки, расчёты, интеграции и обработка данных.",
    icon: CodePython,
    bg: "bg-[#B19CD9]",
  },
  {
    ...
    label: "База данных",
    helper:
      "Храним заявки и статусы в порядке — чтобы всё было видно и можно было развивать.",
    icon: Database,
    bg: "bg-[#A2D2FF]",
  },
];
...
const commonAutomations = [
  {
    text: "Заявка с сайта → Telegram/WhatsApp → таблица/CRM",
    note: "ни одна заявка не теряется",
  },
  {
    text: "Автоответ в WhatsApp → сбор контакта",
    note: "клиент получает ответ сразу",
  },
  { text: "Запись/бронь → напоминание за 24 часа", note: "меньше неявок" },
  {
    text: "Счёт/квитанция → отправка клиенту → статус \u00ABоплачено\u00BB",
    note: "меньше ручной проверки",
  },
  {
    text: "Еженедельный отчёт: лиды/расход/выручка на email",
    note: "понятно, что происходит",
  },
];
...
const automationRouteCards = [
  {
    title: "Сначала настроить трекинг",
    text: "Если автоматизация должна опираться на заявки, статусы и источники, сначала лучше привести в порядок данные и события.",
    href: "/tracking",
    icon: Target,
  },
  {
    title: "Усилить сайт",
    text: "Если автоматизации нужны для записи, заявок и CRM, они лучше работают вместе с понятным сайтом и нормальными страницами услуг.",
    href: "/web/business-websites",
    icon: Workflow,
  },
  {
    title: "Обсудить задачу",
    text: "Если задача уже понятна, проще сразу отправить короткий бриф через контактную страницу.",
    href: "/contact",
    icon: Mail,
  },
];
          ...
          <div className="container mx-auto max-w-7xl relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="text-left">
                ...
                >
                  Внедряем AI и автоматизацию, чтобы заявки обрабатывались
                  быстрее, клиенты не терялись, а рутина исчезла из вашего дня.
                </motion.p>
                ...
                >
                  ...
                  >
                    <Link
                      href="/contact"
                      data-cta-track="true"
                      data-cta-name="Обсудить автоматизацию"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
              ...
              <div className="rounded-2xl bg-[#06D6A0] border-2 border-[#1A1A1A] shadow-[6px_6px_0px_0px_#1A1A1A] p-6 hover:-translate-y-[2px] hover:-translate-x-[2px] hover:shadow-[10px_10px_0px_0px_#1A1A1A] transition-all">
                ...
                <ul className="space-y-3 text-sm text-[#1A1A1A]/80 font-bold tracking-tight">
                  ...
                  <li className="flex gap-3">
                    <span className="mt-1.5 h-2 w-2 rounded-full border border-[#1A1A1A] bg-white shrink-0" />
                    <span>Вы видите, что происходит в бизнесе</span>
                  </li>
                </ul>
              </div>
          ...
          <div className="container mx-auto max-w-6xl px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-[#1A1A1A]/60 text-lg max-w-2xl mx-auto">
                Убираем человеческий фактор там, где это возможно. Быстро, точно
                и без выходных.
              </p>
            </div>
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-12">
              ...
              <p className="mx-auto max-w-3xl text-lg text-[#1A1A1A]/60">
                Автоматизация редко существует сама по себе. Обычно она
                усиливает сайт, трекинг, обработку заявок и работу команды.
                Поэтому важно сразу видеть, что еще стоит подключить рядом.
              </p>
            </div>
            ...
            <div className="mx-auto max-w-4xl">
              <div className="rounded-3xl border-2 border-[#1A1A1A] bg-[#A2D2FF] p-8 shadow-[8px_8px_0px_0px_#1A1A1A]">
                ...
                <h3 className="mt-3 text-2xl font-bold text-[#1A1A1A]">
                  Что обычно идет рядом с автоматизацией
                </h3>

                <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-3">
                  {automationRouteCards.map((card) => (
                    <Link
                      key={card.href}
                      href={card.href}
          ...
          <div className="container mx-auto max-w-6xl px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-[#1A1A1A]/60 text-lg max-w-3xl mx-auto">
                ...
                автоматизации, которые дадут максимум эффекта и сколько это
                будет стоить.
              </p>
            </div>
              ...
              <div className="rounded-3xl bg-[#B19CD9] border-2 border-[#1A1A1A] p-8 shadow-[8px_8px_0px_0px_#1A1A1A]">
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-[#1A1A1A]/40">
                      Все основные запросы мы ведем через `/contact`
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-5">
                  <p className="text-sm leading-relaxed text-[#1A1A1A]/75">
                    Опишите задачу коротко через{" "}
                    <span className="font-bold">/contact</span>. Мы разберем
                    текущий процесс, предложим разумный первый шаг и скажем, что
                    стоит внедрять сразу, а что позже.
                  </p>

                  <div className="rounded-2xl border-2 border-[#1A1A1A] bg-white p-5 shadow-[4px_4px_0px_0px_#1A1A1A]">
                    <div className="text-sm font-bold text-[#1A1A1A]">
                      Что лучше прислать в запросе
                    </div>
                    <ul className="mt-4 space-y-3 text-sm text-[#1A1A1A]/70">
                      {[
                        "какой процесс сейчас отнимает время или ломается",
                        "какие инструменты уже используются: сайт, CRM, таблицы, WhatsApp, Telegram",
                        "какой результат нужен: меньше ручной работы, быстрее ответ, меньше потерь лидов",
                      ].map((item) => (
                  ...
                  <div className="text-xs text-[#1A1A1A]/40 text-center">
                    Один понятный канал связи. Так заявка, обсуждение и
                    следующий шаг не распадаются на разные переписки.
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 md:py-24 px-4">
          <div className="container mx-auto max-w-4xl text-center">
            ...
            <p className="text-xl text-[#1A1A1A]/60 mb-10">
              Оставьте короткий бриф. Посмотрим, где автоматизация реально
              снимет ручную нагрузку и ускорит работу команды.
            </p>
